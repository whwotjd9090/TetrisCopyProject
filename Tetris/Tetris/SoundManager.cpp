...
void SoundManager::SoundLoading()
{
	...
	ErrorCheck(fSystem->createSound("sounds/play_background_1.mp3", FMOD_LOOP_NORMAL, nullptr, &fSound.at(SOUND_PLAY_BACKGROUND)));
	ErrorCheck(fSystem->createSound("sounds/gameover.mp3", FMOD_LOOP_NORMAL, nullptr, &fSound.at(SOUND_GAMEOVER)));
}
